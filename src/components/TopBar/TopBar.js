...
const pageTitles = {
	...
	"/faculties": {
		...
		subtitle: "Manage faculties and their associated departments",
	},
	"/courses": {
		title: "Course Registry",
		subtitle: "Register and manage courses across departments",
	},
	"/rooms": {
		title: "Room Registry",
		subtitle: "Manage venues and their capacities",
	},
	"/timetable/lectures": {
		title: "Lecture Timetable",
		subtitle: "View and manage the weekly lecture schedule",
	},
	"/timetable/exams": {
		title: "Exam Timetable",
		subtitle: "Schedule and manage examination sessions",
	},
	"/staff": {
	...
	"/terms": {
		...
		subtitle: "Configure academic sessions and semesters",
	},
};
		...
		<header
			...
			style={
				!window.matchMedia(MOBILE_QUERY).matches
					...
					: {
							left: isMobileOpen && "var(--sidebar-width",
							transition: "left var(--transition-base)",
						}
			}>
