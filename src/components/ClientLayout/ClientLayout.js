...
function LayoutInner({ children }) {
    ...
    const mainClass = isSidebarCollapsed ? `${styles.main} ${styles.mainCollapsed}` : styles.main;
    ...
    return (
        <AppProvider>
            ...
            />
            <TopBar isSidebarCollapsed={isSidebarCollapsed} toggleCollapse={handleToggle} />
            {isMobileMenuOpen && (
                <div className={styles.backdrop} onClick={() => setIsMobileMenuOpen(false)} aria-hidden />
            )}
