                            ...
                            <>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button className="btn btn-primary" disabled={!automateConfirmed} style={{ opacity: automateConfirmed ? 1 : 0.4, cursor: automateConfirmed ? 'pointer' : 'not-allowed' }} onClick={() => {
                                        ...
                                        setTimeout(() => {
                                            setAutomateResult({ placed: 28, unplaced: 2, unplacedCourses: [{ code: 'CSC 401', reason: 'No room with sufficient capacity' }, { code: 'EEE 305', reason: 'Department time slot conflict' }] });
